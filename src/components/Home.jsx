        ...
        <div className="mx-auto max-w-7xl lg:mx-0">
          ...
          <div className="flex mt-8"> {/* Add margin-top to move the content down */}
            <div className="w-1/2 pl-4"> {/* Move the paragraph to the left */}
              ...
              <br/>
              <div className="mt-4">
                <Link to="/items" className="flex items-center justify-center rounded-md border border-transparent bg-indigo-600 px-4 py-3 text-base font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 max-w-sm">Go to Shop</Link>
              </div>
            </div>
